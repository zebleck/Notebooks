...
plt.ylabel('NRMSE')
plt.ylim(0.,0.032)
plt.savefig('figures/NRMSEvsTrainingPoints.png',bbox_inches="tight")
plt.savefig('figures/NRMSEvsTrainingPoints.svg',bbox_inches="tight")
plt.savefig('figures/NRMSEvsTrainingPoints.eps',bbox_inches="tight")
plt.savefig('figures/NRMSEvsTrainingPoints.pdf',bbox_inches="tight")
plt.show()
