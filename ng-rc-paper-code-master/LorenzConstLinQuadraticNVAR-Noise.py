...
plt.savefig('figures/predict-lorenz-noisy.png')
plt.savefig('figures/predict-lorenz-noisy.svg')
plt.savefig('figures/predict-lorenz-noisy.eps')
plt.savefig('figures/predict-lorenz-noisy.pdf')
