...
do_plot(**do_nvar())
plt.savefig('figures/predict-dscroll.png')
plt.savefig('figures/predict-dscroll.svg')
plt.savefig('figures/predict-dscroll.eps')
plt.savefig('figures/predict-dscroll.pdf')
