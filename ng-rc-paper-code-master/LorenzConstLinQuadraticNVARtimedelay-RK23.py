...
plt.savefig('figures/predict-lorenz.png')
plt.savefig('figures/predict-lorenz.svg')
plt.savefig('figures/predict-lorenz.eps')
plt.savefig('figures/predict-lorenz.pdf')
